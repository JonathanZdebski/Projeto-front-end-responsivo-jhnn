        ...
        <div className={styles.title}>
          ...
          <ul className={styles.resumetext}>
            ...
            <li style={{ listStyleType: "disc" }}>
              ...
              componente, é possível concentrar-se apenas na lógica do
              componente e manter os dados em um arquivo separado. Isso ajuda a
              tornar o código mais organizado e mais fácil de manter. Algumas
              vantagens são a reutilização de dados, facilidade de manutenção,
              performance e testabilidade do código.
            </li>
            <br />
            <li style={{ listStyleType: "disc" }}>
              Para deixar o projeto responsivo usamos uma lógica utilizando
              if/else e fazendo mapeamento dos Links do Navbar para o modo
              mobile, tudo de forma dinâmica (props).
            </li>
            <br />
            <li style={{ listStyleType: "disc" }}>
